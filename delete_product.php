...
echo "<section class='bg-primary'>
	<article class='py-5 text-center text-white'>
	 	<div>
	 		<h3 class='display-4 text-white'>Delete a product from inventory</h3>
...
?>	
	...
	<?php
		...
		echo "<form action = 'populate_delete_product_dropdown.php' method= 'post'>";
		echo " ‎<label for='products' class='btn btn-dark'>‏‏‎ ‎Choose a product to delete : ‎</label>";

			echo "<select name='products' class='btn btn-primary' method= 'post'>";
			...
			echo "<br>";
			echo "<br>";
			echo "<input type='submit' class='btn btn-warning' value='‏‏‎ ‎Delete'>";
			echo "</form>";
			echo "</div>";
		}
