...
echo "<meta charset = 'UTF-8'>";
	...
	$sql = "SELECT Product_name, Unit_price FROM  product,inventory WHERE product.Product_id = inventory.Product_id";
...
echo"<div class='text-center'>";
	...
	echo "<a href='index(1).html' class='btn btn-primary'>‏‏‎ ‎‏‏‎Go to Homepage ‎</a>";
	echo "<br>";
	echo "<br>";
	echo "</div>";
